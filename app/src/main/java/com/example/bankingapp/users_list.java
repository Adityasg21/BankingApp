...
public class users_list extends AppCompatActivity {
        ...
        private void showData() {
            ...
            adapter = new CustomeAdapter_userlist(users_list.this, modelList_showlist);
        ...
        public void nextActivity(int position) {
            ...
            Intent intent = new Intent(users_list.this, user_data.class);
        ...
        public boolean onOptionsItemSelected(@NonNull MenuItem item) {
            if(item.getItemId()==R.id.action_history){
                startActivity(new Intent(users_list.this, history_list.class));
            }
